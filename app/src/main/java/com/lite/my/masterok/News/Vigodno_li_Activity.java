...
public class Vigodno_li_Activity extends AppCompatActivity {
    ...
    class ParsAllRecipe extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            String urlHome = "http://budport.com.ua/articles/category/16-vygody-kak-ekonomit-teplo-i-energiyu";
            ...
            try {
                ...
                Element page = pages.get(pages.size()-1);
                ...
                for (int i = 1; i <= count; i++){
                    ...
                    String url = "http://budport.com.ua/articles/category/16-vygody-kak-ekonomit-teplo-i-energiyu?page=" + i;
                    itemRecipe(url);
                }
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            Intent intent = new Intent(Vigodno_li_Activity.this, ListRecipeActivity.class);
