...
public class EkoStroykaActivity extends AppCompatActivity {
    ...
    class ParsAllRecipe extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            String urlHome = "http://budport.com.ua/articles/category/20-innovacii-v-ekomaterialy-tehnologii-stroitelstvo";
            ...
            try {
                ...
                for (int i = 1; i <= count; i++){
                    ...
                    String url = "http://budport.com.ua/articles/category/20-innovacii-v-ekomaterialy-tehnologii-stroitelstvo?page=" + i;
                    itemRecipe(url);
                }
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            Intent intent = new Intent(EkoStroykaActivity.this, ListRecipeActivity.class);
