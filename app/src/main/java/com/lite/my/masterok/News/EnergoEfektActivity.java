...
public class EnergoEfektActivity extends AppCompatActivity {
    ...
    class ParsAllRecipe extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            String urlHome = "http://budport.com.ua/articles/category/18-vse-pro-energoeffektivnost";
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            Intent intent = new Intent(EnergoEfektActivity.this, ListRecipeActivity.class);
