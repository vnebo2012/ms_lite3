...
public class SteniActivity extends AppCompatActivity {
    ...
    class ParsAllRecipe extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            String urlHome = "http://budport.com.ua/articles/category/28-steny";
            ...
            try {
                ...
                for (int i = 1; i <= count; i++){
                    ...
                    String url = "http://budport.com.ua/articles/category/28-steny?page=" + i;
                    itemRecipe(url);
                }
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            Intent intent = new Intent(SteniActivity.this, ListRecipeActivity.class);
